...
model_name_or_path = "/home/ubuntu/outputs/moe_mt/mixtral_2group/sft_mt/wmt18_cs-de-ru_en/Llama-1B_2group_4experts_top1_fft"
model_name_or_path = "/home/ubuntu/outputs/moe_mt/mixtral_2group/sft_mt/wmt18_x2-1of3/Llama-1B_2group_4experts_top1_fft-bl0.1"
...
root = '/home/ubuntu/zll/mt/wmt_test/wmt18_text_x-en/'
def main():
    # parser = argparse.ArgumentParser()
    # parser.add_argument(
    #     "--input_file", type=str, default=None,
    ...
    for i in range(1):
        ...
        output_file = f'/home/ubuntu/zll/mt/wmt_test/llama3_mixtral2group/output/cs-de-ru_en/{lang}-en.jsonl'
        output_file = f'/home/ubuntu/zll/mt/wmt_test/llama3_mixtral2group/output/x2-1of3/{lang}-en.jsonl'
