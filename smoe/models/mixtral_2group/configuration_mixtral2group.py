...
""" Mixtral2group model configuration"""
...
MIXTRAL2GROUP_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "mistral-ai/Mixtral-2group-1B": "https://huggingface.co/mistral-ai/Mixtral-8x7B/resolve/main/config.json",
}
...
class Mixtral2GroupConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_local_experts_group0 = num_local_experts_group0
        self.num_local_experts_group1 = num_local_experts_group1
        self.scale_factor = scale_factor  # 🔍
        self.use_fft = use_fft  ## 跟模型有关系
        self.output_router_logits = output_router_logits
        self.router_aux_loss_coef = router_aux_loss_coef
        self.moe_type = moe_type  # 🔍
        self.num_moe_insert_layers = num_moe_insert_layers  # 🔍
